...
parser.add_argument('--lr_decay_encoder', type=int, default=200,
                    help='learning rate decay per N epochs')
parser.add_argument('--lr_decay_sr', type=int, default=250,
                    help='learning rate decay per N epochs')
parser.add_argument('--decay_type', type=str, default='step',
                    help='learning rate decay type')
parser.add_argument('--gamma_encoder', type=float, default=0.3,
...
# Log specifications
parser.add_argument('--save', type=str, default='teacher',
