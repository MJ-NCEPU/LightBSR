...
parser.add_argument('--initparams', action='store_true',
                    help='set this option to test the model')
...
parser.add_argument('--lr_decay_encoder', type=int, default=160,
...
# Log specifications
# TODO: setting1
parser.add_argument('--tea_path', type=str, default='./experiment/teacher_x4_bicubic_iso',
                    help='teacher model .pth path')
# TODO: setting2
# parser.add_argument('--tea_path', type=str, default='./experiment/teacher_x4_bicubic_aniso',
#                     help='teacher model .pth path')
parser.add_argument('--save', type=str, default='student',
